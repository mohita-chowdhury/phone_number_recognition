...
PATH = 'speech_net_new.pth.tar'
writer = SummaryWriter('saved/log/runs_new') 

def train(train_gen, max_epochs, n_batches, model, optimizer, gpu_available):
    # Train model
    # Loop over epochs
    ...
    for epoch in range(max_epochs):
        ...
        for i, data in enumerate(tqdm(train_gen)):
            ...
            if running_loss < min_running_loss:
                ...
                torch.save(model.state_dict(), folder_name +'/'+'bestcheckpoint_small.pth.tar')
